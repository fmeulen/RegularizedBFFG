...
By Fubini's theorem applied to the second term we get\footnote{This is the first equation in the note by Jeremy Heng.}
\begin{cor}
...
\end{cor}
Then Heng defines $e_t = - \EE^{\star\circ} \xi_t(X_t)$.... Claim $e_T=0$ is unclear to me. 
